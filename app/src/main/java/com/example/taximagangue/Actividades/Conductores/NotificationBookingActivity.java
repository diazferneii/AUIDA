...
public class NotificationBookingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Mostrar la Notificacion de viaje estando la pantalla bloqueada
        getWindow().addFlags(
        ...
        mListener = mClientBookingProvider.getClientBooking(mExtraIdClient).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (!dataSnapshot.exists()) {
                    ...
                    Intent intent = new Intent(NotificationBookingActivity.this, MapConductoresActivity.class );
    ...
    private void cancelBooking() {
        if (mHandler != null) mHandler.removeCallbacks(runnable);
        mClientBookingProvider = new ClientBookingProvider();
        mClientBookingProvider.updateestatus(mExtraIdClient, "cancel");
    ...
    private void acceptBooking() {
        ...
        mClientBookingProvider = new ClientBookingProvider();
        mClientBookingProvider.updateestatus(mExtraIdClient, "accept");


        NotificationManager manager = (NotificationManager) getSystemService(Context.NOTIFICATION_SERVICE);
        manager.cancel(2);

        Intent intent1 = new Intent(NotificationBookingActivity.this , MapDriverBoookingActivity.class);
